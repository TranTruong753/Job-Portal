<script setup>
    ...
    const schema = yup.object({
        nameSkills: yup.string().required('Name skill is required'),
    });
    ...
    const onSubmit = handleSubmit((values) => {
        ...
        storeDataCv.addItem({ ...values }, Skills);
        console.log("datas", storeDataCv.datas[Skills]);

        closeModal('#specializedSkillsModal')
    ...
    const deleteItem = (index) => {
        ...
        storeDataCv.deleteItemByIndex(Skills, index);
    }
    ...
    <div class="card border-0 shadow mb-4  ">
        <div class="card-body p-0">
            ...
            <div class="m-3 border border-2">
                <div class="p-3 ">
                    <div class="mb-0 " v-if="storeDataCv.datas[Skills].length"
                    v-for="(item, index) in storeDataCv.datas[Skills]" :key="index">
        ...
        <div class="modal-dialog  modal-dialog-centered  modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formSpecializedSkills" @submit.prevent="onSubmit">
                        <div class="row g-3 ">
                            <div class=" col-lg-12">
                                <label for="nameSkills" class="mb-2">Name skill<span class="text-primary">*</span></label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" form="formSpecializedSkills">Save changes</button>
                </div>
            </div>
        </div>
    </div>
